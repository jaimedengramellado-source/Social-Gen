...
import type { ScheduledPost, SocialConnection, PostAutomation } from "@/types";
...
export default async function PublicarPage() {
  ...
  // (ver SETUP.md §10-12 para los pasos de activación)
  if (!flags.youtube && !flags.instagram && !flags.tiktok) {
  ...
  const [{ data: ytConn }, { data: socialConns }, { data: posts }, { data: automations }] =
    await Promise.all([
      supabase
