    ...
    <div className="flex h-full">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        {selection?.type === "script" && (
          <>
            {/* Save / share bar */}
            <div className="flex items-center justify-between px-8 py-2 border-b border-[var(--color-border)] bg-white flex-shrink-0">
            ...
            <div
              className="flex items-center gap-0.5 px-6 py-1.5 border-b border-[var(--color-border)] bg-white flex-shrink-0"
